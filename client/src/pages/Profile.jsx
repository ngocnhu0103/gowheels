...
const Profile = () => {
    ...
    console.log(bikes);
    return (
        <main className="container w-4/5 mx-auto relative min-h-screen flex flex-col justify-between">
            <Header />
            <div className="flex flex-col gap-5">
                <section className="p-4 bg-gray-100/90">
                    <div className="col-span-2 flex gap-5 flex-col justify-center w-fit items-center  rounded-xl p-4">
