...
const PaymentFailureEnd = () => {
    return (
        <div className="bg-gray-100 h-screen flex items-center justify-center">
            <div className="bg-white p-6 flex items-center justify-center flex-col md:mx-auto">
                <svg
                    height="80px"
                    width="80px"
                    version="1.1"
	...
	c0,137.001,111.07,248.07,248.083,248.07C385.089,496.155,496.158,385.086,496.158,248.085z"
		...
		c8.958,0,17.049-3.898,24.047-11.586c6.876-7.553,10.363-16.433,10.363-26.393C321.646,88.105,319.169,81.684,314.282,76.672z"
                ...
                <div className="text-center">
                    ...
                    <p className="text-gray-600 my-2">yêu cầu thanh toán của bạn không thành công.</p>
...
export default PaymentFailureEnd;
