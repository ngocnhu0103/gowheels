    ...
    return (
        <div className="my-8">
            <div className="text-center">
                <h1 className="text-4xl font-bold font-banner text-primary">Hướng dẫn thuê xe</h1>
                <p className="text-xl font-semibold">
                    Chỉ với 4 bước đơn giản để có thể trải nghiệm dịch vụ thuê xe tại GoWheels
                </p>
            </div>
            <ul className="flex mt-10 justify-evenly max-md:flex-col gap-4">
                <li className="w-1/5 text-center border border-primary rounded-lg p-5 max-md:w-full">
