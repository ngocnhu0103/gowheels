    ...
    return (
        <div className="flex border border-primary rounded-xl w-4/5 gap-5 justify-between items-center p-5 mx-auto my-5 ">
            ...
            <div onClick={(e) => {
                ...
                {showCalendar && <div className="absolute left-0 top-20 bg-white p-5 rounded-xl drop-shadow-xl">
                    <div>

                        <DatePicker

                            selected={startDate} startDate={startDate} endDate={endDate}
                            selectsRange
                            minDate={new Date()}
                    ...
                    <div>
                        ...
                        <select name="hour" className="outline-none" value={timeSelected.hour} onChange={(e) => {
                        ...
                        :
                        <select name="minute" className="outline-none" value={timeSelected.minutes}
                            onChange={(e) => {
